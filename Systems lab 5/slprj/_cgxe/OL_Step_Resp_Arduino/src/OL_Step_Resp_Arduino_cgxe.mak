...
MODEL  = OL_Step_Resp_Arduino
TARGET = cgxe
MODULE_SRCS 	= m_ePayuoj95JiWdmGoyRgl3F.c
MODEL_SRC	= OL_Step_Resp_Arduino_cgxe.c
MODEL_REG = OL_Step_Resp_Arduino_cgxe_registry.c
MAKEFILE    = OL_Step_Resp_Arduino_cgxe.mak
...
OBJLIST_FILE = OL_Step_Resp_Arduino_cgxe.mol
