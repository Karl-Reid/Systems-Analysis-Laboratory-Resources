###########################################################################
## Makefile generated for Simulink model 'OL_Step_Resp_Arduino'. 
## 
## Makefile     : OL_Step_Resp_Arduino.mk
## Generated on : Mon Oct 16 12:46:23 2017
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/OL_Step_Resp_Arduino.elf
...
PRODUCT_NAME              = OL_Step_Resp_Arduino
MAKEFILE                  = OL_Step_Resp_Arduino.mk
COMPUTER                  = PCWIN64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/maeuser/Desktop/SYSTEM~1
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = OL_Step_Resp_Arduino_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/OL_Step_Resp_Arduino.elf
...
DEFINES_ = -D_RTT_USE_SERIAL0_ -DMODEL=OL_Step_Resp_Arduino -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DONESTEPFCN=1 -DTERMFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DRT -DSTACK_SIZE=64 -DMW_TIMERID=5 -DMW_PRESCALAR=256 -DMW_TIMERCOUNT=64911 -DMW_SCHEDULERCOUNTER=1 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_BAUDRATE_SERIAL2_=9600 -D_RTT_BAUDRATE_SERIAL3_=9600 -D_RTT_ANALOG_REF_=0 -D_RTT_OVERRUN_DIGITAL_PIN_=13
...
DEFINES_STANDARD = -DMODEL=OL_Step_Resp_Arduino -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
%.o : $(START_DIR)/OL_Step_Resp_Arduino_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/OL_Step_Resp_Arduino_ert_rtw/%.s
	$(AS) $(ASFLAGS)  "$@" "$<"


%.o : $(START_DIR)/OL_Step_Resp_Arduino_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : C:/Users/maeuser/Desktop/THLlib/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : C:/Users/maeuser/Desktop/THLlib/%.s
	$(AS) $(ASFLAGS)  "$@" "$<"


%.o : C:/Users/maeuser/Desktop/THLlib/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
